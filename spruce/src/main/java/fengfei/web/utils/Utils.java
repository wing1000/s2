...
public class Utils {
    ...
    public static String getSimpleNames(Annotation[] values) {
        ...
        StringBuffer toReturn = new StringBuffer("@"
                + iter.next().annotationType().getSimpleName());
        while (iter.hasNext()) {
    ...
    public static class Maps {
        ...
        public static
            void
            mergeValueInMap(Map<String, String[]> map, String name, String[] values) {
    ...
    public static class AlternativeDateFormat {
        ...
        public static AlternativeDateFormat getDefaultFormatter() {
            if (dateformat.get() == null) {
                dateformat.set(new AlternativeDateFormat(Locale.US, "yyyy-MM-dd'T'HH:mm:ss'Z'", // ISO8601
                                                                                                // +
                                                                                                // timezone
